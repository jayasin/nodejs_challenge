...
/* filter deliveries based on some products characteristics */
router.route('/deliveriesFilter')
  .get(
  (req, res, next) => handler(getValidator, req, res, next, validations['deliveriesFilter']),
  (req, res, next) => responses(deliveriesCommonServices.deliveriesFilter, req, res, next))
